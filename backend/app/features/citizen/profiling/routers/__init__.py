...
from app.features.citizen.profiling.routers.profilage import router as profilage_router
from app.features.citizen.profiling.routers.session import router as session_router
