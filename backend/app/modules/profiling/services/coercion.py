...
from app.modules.profiling.schemas.agent import AnalyseReponse, TypeReponsePercue
from app.modules.profiling.schemas.profil import StatutLogement, StatutMarital, StatutProfessionnel, TypeLocation
...
_LOCATION_LABELS = {
    ...
    "logement vide (non meublé)": TypeLocation.vide,
    "location vide": TypeLocation.vide,
    "logement vide": TypeLocation.vide,
    "non meublée": TypeLocation.vide,
    "non meuble": TypeLocation.vide,
    "vide": TypeLocation.vide,
    "location meublée": TypeLocation.meublee,
    "logement meublé": TypeLocation.meublee,
    "location meuble": TypeLocation.meublee,
    "logement meuble": TypeLocation.meublee,
    "meublée": TypeLocation.meublee,
    "meublee": TypeLocation.meublee,
    "meublé": TypeLocation.meublee,
    "meuble": TypeLocation.meublee,
