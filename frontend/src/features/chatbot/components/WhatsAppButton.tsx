...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className={cn(
        'fixed z-40 flex size-14 cursor-grab touch-none items-center justify-center rounded-full bg-[#25D366] text-white shadow-soft transition-transform hover:scale-105 active:cursor-grabbing focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#25D366] focus-visible:ring-offset-2',
        !position && 'bottom-5 left-5',
      )}
    >
      <span
        aria-hidden="true"
        className="motion-safe:animate-ping absolute inset-0 rounded-full bg-[#25D366] opacity-75"
      />
