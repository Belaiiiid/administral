...
/**
 * Tables carry no vertical borders — only 1px horizontal dividers.
 * Headers use label-sm uppercase (design-analysis §2.1).
 */
...
>(({ className, ...props }, ref) => (
  <th
    ...
    scope="col"
    className={cn(
      'px-4 py-3 text-left text-label-sm uppercase tracking-wider text-muted-foreground',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td ref={ref} className={cn('px-4 py-4 text-body-sm text-on-surface', className)} {...props} />
));
